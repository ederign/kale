...
def load_transform_data_step(
    ...
    x_trn_artifact: Output[Dataset],
    x_tst_artifact: Output[Dataset],
    y_trn_artifact: Output[Dataset],
    y_tst_artifact: Output[Dataset],
...
def train_model_step(
    ...
    x_trn_artifact: Input[Dataset],
    y_trn_artifact: Input[Dataset],
...
def evaluate_model_step(
    ...
    x_tst_artifact: Input[Dataset],
    y_tst_artifact: Input[Dataset],
    n_estimators_param: int = 500,
    max_depth_param: int = 2,
):
    _kale_pipeline_parameters_block = f"""
