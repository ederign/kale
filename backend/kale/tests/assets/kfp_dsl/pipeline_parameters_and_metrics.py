...
def create_matrix_step(
    create_matrix_html_report: Output[HTML],
    rnd_matrix_artifact: Output[Dataset],
    d1: int = 5,
    d2: int = 6,
    booltest: bool = True,
    strtest: str = "test",
...
def sum_matrix_step(
    sum_matrix_html_report: Output[HTML],
    rnd_matrix_artifact: Input[Dataset],
    d1: int = 5,
    d2: int = 6,
    booltest: bool = True,
    strtest: str = "test",
...
@kfp_dsl.pipeline(name="hp-test", description="")
def auto_generated_pipeline(
    d1: int = 5, d2: int = 6, booltest: bool = True, strtest: str = "test"
):
    """Auto-generated pipeline function."""

    create_matrix_task = create_matrix_step(
        d1=d1, d2=d2, booltest=booltest, strtest=strtest
    )
